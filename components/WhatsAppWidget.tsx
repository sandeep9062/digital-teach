...
export default function WhatsAppWidget() {
  ...
  const whatsappLink = "https://wa.me/918894110026";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      >
        {/* Header */}
        <div className="bg-[#2637cf] text-white p-4 flex items-start rounded-t-xl">
        ...
        >
          ...
          <div className="ml-4">
            <h3 className="text-sm font-semibold text-gray-800">VproTech Digital</h3>
      ...
      <button
        ...
        className="bg-[#4128e5] hover:bg-[#080d6f] p-4 rounded-full shadow-xl text-white transition duration-300"
      >
        {isOpen ? (
